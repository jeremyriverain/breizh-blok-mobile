...
class BbLazyIndexedStack extends StatefulWidget {
  const BbLazyIndexedStack({
    super.key,
  ...
  @override
  BbLazyIndexedStackState createState() => BbLazyIndexedStackState();
}

class BbLazyIndexedStackState extends State<BbLazyIndexedStack> {
  ...
  @override
  void didUpdateWidget(covariant BbLazyIndexedStack oldWidget) {
