...
class BoulderDetailsLayout extends StatefulWidget {
  const BoulderDetailsLayout({
    required this.id,
    this.boulderAreaIri,
    super.key,
  });
  ...
  @override
  State<BoulderDetailsLayout> createState() => _BoulderDetailsLayoutState();
}

class _BoulderDetailsLayoutState extends State<BoulderDetailsLayout> {
