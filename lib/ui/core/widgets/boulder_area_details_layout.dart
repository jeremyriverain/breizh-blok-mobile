...
class BoulderAreaDetailsLayout extends StatefulWidget {
  const BoulderAreaDetailsLayout({required this.id, super.key});
  final String id;

  @override
  State<BoulderAreaDetailsLayout> createState() =>
      _BoulderAreaDetailsLayoutState();
}

class _BoulderAreaDetailsLayoutState extends State<BoulderAreaDetailsLayout> {
