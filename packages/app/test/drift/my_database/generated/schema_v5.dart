...
class DepartmentTable extends Table
    with TableInfo<DepartmentTable, DepartmentTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
...
class DepartmentTableData extends DataClass
  ...
  final String iri;
  final String name;
  const DepartmentTableData({required this.iri, required this.name});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['iri'] = Variable<String>(iri);
  ...
  DepartmentTableCompanion toCompanion(bool nullToAbsent) {
    return DepartmentTableCompanion(iri: Value(iri), name: Value(name));
  }
  ...
  DepartmentTableData copyWith({String? iri, String? name}) =>
      DepartmentTableData(iri: iri ?? this.iri, name: name ?? this.name);
...
class MunicipalityTable extends Table
    with TableInfo<MunicipalityTable, MunicipalityTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  MunicipalityTable(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> iri = GeneratedColumn<String>(
    'iri',
    aliasedName,
    false,
  ...
  @override
  List<GeneratedColumn> get $columns => [iri, name, department];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  MunicipalityTable createAlias(String alias) {
    return MunicipalityTable(attachedDatabase, alias);
  }
...
class MunicipalityTableData extends DataClass
  ...
  @override
  int get hashCode => Object.hash(iri, name, department);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class DatabaseAtV5 extends GeneratedDatabase {
  ...
  late final DepartmentTable departmentTable = DepartmentTable(this);
  late final GradeTable gradeTable = GradeTable(this);
  late final MunicipalityTable municipalityTable = MunicipalityTable(this);
