...
class RockApi {
  ...
  const RockApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ApiRocksGetCollection200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiRocksGetCollection200Response>> apiRocksGetCollection({
    int? page = 1,
    bool? pagination,
    ...
    ApiRocksGetCollection200Response? _responseData;
    ...
    return Response<ApiRocksGetCollection200Response>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RockJsonldRockRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RockJsonldRockRead>> apiRocksIdGet({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    RockJsonldRockRead? _responseData;
    ...
    return Response<RockJsonldRockRead>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
