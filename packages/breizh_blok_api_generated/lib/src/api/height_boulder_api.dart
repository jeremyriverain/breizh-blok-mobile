...
class HeightBoulderApi {
  final Dio _dio;

  final Serializers _serializers;

  const HeightBoulderApi(this._dio, this._serializers);
  ...
  Future<Response<ApiHeightBouldersGetCollection200Response>>
    ...
    ApiHeightBouldersGetCollection200Response? _responseData;
    ...
    return Response<ApiHeightBouldersGetCollection200Response>(
      data: _responseData,
  ...
  Future<Response<HeightBoulderJsonldHeightBoulderRead>>
    ...
    HeightBoulderJsonldHeightBoulderRead? _responseData;
    ...
    return Response<HeightBoulderJsonldHeightBoulderRead>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
