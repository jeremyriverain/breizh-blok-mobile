...
class MediaApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ApiMediaGetCollection200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiMediaGetCollection200Response>> apiMediaGetCollection({
    int? page = 1,
    ...
    ApiMediaGetCollection200Response? _responseData;
    ...
    return Response<ApiMediaGetCollection200Response>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [MediaJsonld] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MediaJsonld>> apiMediaIdGet({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
