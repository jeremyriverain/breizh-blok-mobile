...
class BoulderAreaApi {
  final Dio _dio;

  final Serializers _serializers;

  const BoulderAreaApi(this._dio, this._serializers);
  ...
  Future<Response<ApiBoulderAreasGetCollection200Response>>
    ...
    ApiBoulderAreasGetCollection200Response? _responseData;
    ...
    return Response<ApiBoulderAreasGetCollection200Response>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BoulderAreaJsonldBoulderAreaItemGet] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BoulderAreaJsonldBoulderAreaItemGet>> apiBoulderAreasIdGet({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    BoulderAreaJsonldBoulderAreaItemGet? _responseData;
    ...
    return Response<BoulderAreaJsonldBoulderAreaItemGet>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
