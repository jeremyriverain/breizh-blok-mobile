...
// in breizh_blok_mobile/integration_test/app_test.dart.
...
class _FakeShareResult_2 extends _i1.SmartFake implements _i3.ShareResult {
  _FakeShareResult_2(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockMixpanel extends _i1.Mock implements _i2.Mixpanel {
  ...
  @override
  _i4.Future<bool?> hasOptedOutTracking() => (super.noSuchMethod(
        Invocation.method(
          #hasOptedOutTracking,
          [],
        ),
  ...
  @override
  _i4.Future<void> identify(String? distinctId) => (super.noSuchMethod(
        Invocation.method(
          #identify,
          [distinctId],
        ),
  ...
  @override
  _i4.Future<void> trackWithGroups(
    String? eventName,
    Map<String, dynamic>? properties,
  ...
  @override
  _i4.Future<void> registerSuperProperties(Map<String, dynamic>? properties) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<void> registerSuperPropertiesOnce(
          Map<String, dynamic>? properties) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<void> unregisterSuperProperty(String? propertyName) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<Map<dynamic, dynamic>?> getSuperProperties() =>
      (super.noSuchMethod(
        Invocation.method(
          #getSuperProperties,
          [],
        ...
        returnValueForMissingStub: _i4.Future<Map<dynamic, dynamic>?>.value(),
      ) as _i4.Future<Map<dynamic, dynamic>?>);
  @override
  _i4.Future<void> clearSuperProperties() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i4.Future<double?> eventElapsedTime(String? eventName) =>
      (super.noSuchMethod(
        Invocation.method(
          #eventElapsedTime,
          [eventName],
...
class MockShareContentService extends _i1.Mock
    implements _i6.ShareContentService {
  @override
  _i4.Future<_i3.ShareResult> share(String? text) => (super.noSuchMethod(
        Invocation.method(
          #share,
          [text],
        ),
        returnValue: _i4.Future<_i3.ShareResult>.value(_FakeShareResult_2(
          this,
          Invocation.method(
            #share,
            [text],
        ...
        returnValueForMissingStub:
            _i4.Future<_i3.ShareResult>.value(_FakeShareResult_2(
          this,
          Invocation.method(
            #share,
            [text],
